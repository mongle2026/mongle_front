...
// {
//   feedId, visibility,
//   user: { userId, userCode, nickname, hasProfileImage, profileImageUrl },
//   record: { recordId, date, text },
//   music: { musicId, externalId, musicTitle, musicArtist, musicArtwork },
//   files: [{ fileId, fileType, mimeType, originalName, fileSize, url }],
